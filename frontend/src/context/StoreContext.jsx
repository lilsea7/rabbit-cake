...
//     // Lấy danh sách yêu thích từ localStorage khi khởi động
...
//       const newFavorites = [...new Set([...prev, itemId])]; // Tránh trùng lặp
//       localStorage.setItem("favoriteItems", JSON.stringify(newFavorites));
//       if (token) {
//         axios.post(url + "/api/favorites/add", { itemId }, { headers: { token } });
//       }
//       return newFavorites;
//     });
//   };
...
//       localStorage.setItem("favoriteItems", JSON.stringify(newFavorites));
//       if (token) {
//         axios.post(url + "/api/favorites/remove", { itemId }, { headers: { token } });
//       }
//       return newFavorites;
//     });
//   };
...
//   useEffect(() => {
//     // Đồng bộ favoriteItems với localStorage mỗi khi thay đổi
